    ...
    <div class="min-h-full">
                ...
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <img class="h-8 w-8" src="img/blog.png" alt="Your Company">
                        </div>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <article>
                    <h3>judul blog 1</h3>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos, eligendi doloremque. Quaerat
                        recusandae eveniet soluta enim, necessitatibus perferendis nesciunt, id optio repellendus harum
                        magni possimus pariatur, repudiandae porro provident aspernatur.</p>
                </article>
            </div>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <!-- Your content -->
